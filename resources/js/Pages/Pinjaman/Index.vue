            ...
            <template v-slot:content>
                <div class="flex flex-row space-x-4">
                    <div class=" w-fit">
                        ...
                        <p>Tambahkan data pinjaman nasabah dengan menekan tombol dibawah ini, pastikan semua formulir diisi dengan valid</p>
                        <div class="mt-4">
        ...
        <CardBody>
            <template v-slot:content>
                <Table
                    ...
                    :deleteData="true"
                    deleteRoute="pinjaman.delete"
                    :editData="true"
                    editRoute="pinjaman.edit"
                    :totalData="totalData"
                    :endRow="endRow"
                    :actionUsingId=true
                    @refreshed-data="()=>{
                ...
                >
                    <template v-slot:filter>
                        <a :href="route('pinjaman.download',{tahun : tahun, bulan: bulan, status: status})" class="border px-3 rounded-md border-gray-300 bg-gray-50 inline-flex items-center text-gray-600 space-x-1">
