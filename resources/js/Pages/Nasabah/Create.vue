        ...
        <template v-slot:content>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input id="nomor_telepon" v-model="form.nomor_telepon" type="text"
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" />
                ...
                <div>
                    ...
                    <input id="nomor_identitas" v-model="form.nomor_identitas" type="text"
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" />
                ...
                <div>
                    ...
                    <input id="pekerjaan" v-model="form.pekerjaan" type="text"
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" />
...
export default {
    ...
    methods: {
        async postData() {
            try {
                await axios.post(route('nasabah.store'), this.form);
